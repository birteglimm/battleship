...
import battleship.players.CustomComputerOpponent;
...
public class GameHandler {
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        if (playerNumber == 0) {
            playerOne = new CustomComputerOpponent("The Spanish Armada");
            playerTwo = new CustomComputerOpponent("Perfidious Albion");
            showBothFleets = true;
